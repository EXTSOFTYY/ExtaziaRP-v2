    ...
    if (message.content === prefix + "sondagerp-21h") {
        if(message.author.id == "406124485612142592", "344771703039066113"){
            ...
            var sondagerp21h_embed = new Discord.RichEmbed()
                ...
                .addField("Seras-tu disponible à la session RP de 21h00 le 02/06/19 ? Afin qu'une session se lance un minimum de 12 « ✅ » est requis.", "Répondez ci-dessous grace aux émojis. ")
