...
bot.on('message', message => {
    ...
    if (message.content === prefix + "ci Thibault Savastano"){
        message.delete();
        message.channel.send("Voici la ci d'identité de Thibault Savastano:", {
            file: "https://zupimages.net/up/19/11/620k.jpg"
        });
        console.log("[BOT ExtaziaRP] LOGS -> Un utilisateur demande la commande -> /ci Thibault Savastano [Succès].");
